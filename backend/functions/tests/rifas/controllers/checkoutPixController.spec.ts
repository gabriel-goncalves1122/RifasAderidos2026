...
jest.mock("../../../src/modules/rifas/rifasService", () => ({
  RifasService: {
    criarCheckoutPix: mocks.criarCheckoutPix,
    consultarCheckoutPix: mocks.consultarCheckoutPix,
    processarWebhookCheckoutPix: mocks.processarWebhookCheckoutPix,
  },
}));

import { criarCheckoutPix } from "../../../src/modules/rifas/controllers/criarCheckoutPixController";
import { consultarCheckoutPix } from "../../../src/modules/rifas/controllers/consultarCheckoutPixController";
import { receberWebhookCheckoutPix } from "../../../src/modules/rifas/controllers/receberWebhookCheckoutPixController";

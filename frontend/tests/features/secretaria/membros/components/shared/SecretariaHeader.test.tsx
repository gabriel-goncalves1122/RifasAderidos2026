// ============================================================================
// ARQUIVO: frontend/tests/features/secretaria/membros/components/shared/SecretariaHeader.test.tsx
// ============================================================================
import { render, screen, fireEvent } from "@testing-library/react";
import { describe, expect, it, vi } from "vitest";

import { SecretariaHeader } from "@/features/secretaria/membros/components/shared/SecretariaHeader";
...
describe("Componente: SecretariaHeader", () => {
  ...
  it("Nao deve renderizar navegacao principal no header", () => {
    renderHeader();

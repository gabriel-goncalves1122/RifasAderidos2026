...
export const HeroPremioCard = ({ premio, isAdmin, onEditClick }: HeroPremioCardProps) => (
  ...
  >
    ...
    <Box sx={{ position: "relative", width: { sm: 280 }, flexShrink: 0 }}>
      {premio.imagem_url ? (
        <CardMedia
          component="img"
    ...
    >
      ...
      <Typography variant="h4" sx={{ ...typography.cardTitulo, fontSize: { xs: "1.4rem", sm: "1.6rem" } }}>
        {premio.titulo}
      </Typography>
      <Typography
        variant="body1"
        color="text.secondary"
        sx={{ mt: "auto", px: { xs: 1, sm: 0 }, lineHeight: 1.5 }}
      >
        {premio.descricao}
      </Typography>
    </CardContent>
